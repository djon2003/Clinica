Public Class DateFormat
    ...
    Public Shared Function transformIntervalToString(ByVal span As TimeSpan) As String
        Dim interval As String = String.Empty
        If span.Days <> 0 Then interval &= span.Days & "j "
        If span.Hours <> 0 Then interval &= span.Hours & "h"
        If span.Minutes <> 0 Then interval &= span.Minutes & "m"
        If span.Seconds <> 0 Then interval &= span.Seconds & "s"
        If span.Milliseconds <> 0 Then interval &= span.Milliseconds & "ms"

        Return interval
    End Function

    Public Shared Function transformIntervalToString(ByVal milliSeconds As Integer) As String
        Return transformIntervalToString(TimeSpan.FromMilliseconds(milliSeconds))
    End Function
