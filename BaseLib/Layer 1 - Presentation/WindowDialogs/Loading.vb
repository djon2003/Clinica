...
#End Region
    ...
    Protected Shared ReadOnly Property isLoaded() As Boolean
        Get
            Return loaded
        End Get
    End Property

    Public Sub appendDetail(ByVal textToAdd As String)
        loadingDetail.Text += textToAdd
    ...
    Protected Shared Sub setInstance(ByVal mySelf As Loading)
        Loading.mySelf = mySelf
        loaded = True
    End Sub

    Public Shared Function getInstance() As Loading
        If loaded = False Then setInstance(New Loading())
