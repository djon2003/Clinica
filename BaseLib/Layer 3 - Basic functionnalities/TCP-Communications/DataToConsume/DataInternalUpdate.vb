Public Class DataInternalUpdate
    ...
    Private Shared emptyParams = New String() {}
...
#End Region
    ...
    Public Sub New(ByVal noMessage As Integer, ByVal update As String, ByVal fromExternal As Boolean)
        ...
        Dim myFunction() As String = update.Replace(vbCrLf, "").Split(New Char() {"("})
        ...
        If params.Length = 1 AndAlso params(0) = String.Empty Then params = emptyParams
