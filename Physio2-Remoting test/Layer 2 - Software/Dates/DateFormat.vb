'TODO : Shall be deleted to use the one from BaseLib
Public Class DateFormat
    ...
    Public Shared Function chooseMonth() As Integer
        ...
        Dim myMonth As Integer = myMultiChoice.GetChoice("Veuillez sélectionner le mois", String.Join("§", monthsNames), "INDEX", "§", False, monthsNames(Date.Today.Month - 1))
        Return myMonth
    End Function
    ...
    Public Enum TextDateOptions
        ...
        WeekDayName = 11
        YYYYMMDD_FullTime = 12
    End Enum

    Public Shared Function isTimesOverlap(ByVal firstStartTime As Date, ByVal firstEndTime As Date, ByVal secondStartTime As Date, ByVal secondEndTime As Date) As Boolean
        Return ((time1Suptime2(firstStartTime, secondStartTime, False) = False And time1Suptime2(firstEndTime, secondStartTime, False) = True) Or (time1Suptime2(firstStartTime, secondEndTime, True) = False And time1Suptime2(firstEndTime, secondEndTime, True) = True) Or (time1Suptime2(firstStartTime, secondStartTime, False) = True And time1Suptime2(firstEndTime, secondEndTime, True) = False))
    End Function
    ...
    Public Shared Function getTextDate(ByVal dateToConvert As Date, Optional ByVal options As DateFormat.TextDateOptions = DateFormat.TextDateOptions.YYYYMMDD, Optional ByVal shortSeparator As String = ".", Optional ByVal dateSeparator As String = "/") As String
        ...
        Select Case options
            ...
            Case TextDateOptions.YYYYMMDD_FullTime
                Return MyYear & dateSeparator & MyMonth & dateSeparator & MyDay & " " & MyHour & ":" & MyMinute & ":" & mySecond
