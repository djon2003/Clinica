...
Public Class ReportBasicFooter
    Implements Clinica.ReportFooter
...
#Region "Propriétés"
    ...
    Public ReadOnly Property filtersWhereString() As String Implements ReportElement.filtersWhereString
        Get
            ...
            Return myReport.reportFilter.filterResult.filteringWhereFooter
        End Get
    End Property
...
#End Region
    ...
    Protected Overridable Sub generateHTMLFirstLine(ByRef htmlBuilder As System.Text.StringBuilder) Implements ReportElement.generateHTMLFirstLine
        htmlBuilder.AppendLine("<!-- Rapport Footer -->")
    ...
    Protected Overridable Sub generateHTMLLastLine(ByRef htmlBuilder As System.Text.StringBuilder) Implements ReportElement.generateHTMLLastLine
        htmlBuilder.AppendLine("<!-- End Rapport Footer -->")
    End Sub
    ...
    Public Shared Function findFooter(ByVal classElementName As String, ByRef leRapport As Report, Optional ByVal firstDone As Boolean = False, Optional ByVal firstClass As String = "") As ReportFooter
        Dim myRapportElement As New ReportBasicFooter(leRapport)
        ...
        Return ReportFooterTotal.findFooter(classElementName, leRapport, True, firstClass)
    End Function
