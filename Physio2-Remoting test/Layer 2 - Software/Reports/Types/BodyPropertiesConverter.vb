...
Friend Class BodyPropertiesConverter : Inherits ExpandableObjectConverter
    Public Overloads Overrides Function canConvertTo(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal destinationType As System.Type) As Boolean
        If (destinationType Is GetType(ReportBody)) Then
            Return True
        End If
    ...
    Public Overrides Function convertTo(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal culture As System.Globalization.CultureInfo, ByVal value As Object, ByVal destinationType As System.Type) As Object
        If TypeOf value Is ReportBody Then
            Dim rb As ReportBody = value

            Return rb.propertiesToString
        End If
