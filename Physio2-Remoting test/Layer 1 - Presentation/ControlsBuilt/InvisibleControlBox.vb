...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        Try
            lockWindowImgs = New ImageList()
            lockWindowImgs.ImageSize = New Size(10, 10)
            With lockWindowImgs.Images
                .Add(DrawingManager.getInstance.getImage("unlockwin10.gif"))
                .Add(DrawingManager.getInstance.getImage("lockwin10.gif"))
            End With
            Me.LockWindow.Image = lockWindowImgs.Images(0)
            Me.Fermer.Image = DrawingManager.getInstance.getImage("exitbutton7.gif")
        Catch
        End Try
...
#End Region
    ...
    Public Property isLocked() As Boolean
        ...
        Set(ByVal Value As Boolean)
            ...
            If lockWindowImgs.Images.Count = 0 Then Exit Property

            If Value = True Then
                LockWindow.Image = lockWindowImgs.Images(1)
            Else
                LockWindow.Image = lockWindowImgs.Images(0)
            End If
        End Set
    End Property
    ...
    Private Sub switchTB_Main_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SwitchTB_Main.Click
        ...
        RaiseEvent switchingControl(Not willSwitchToToolBar, True)
    End Sub
