...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        If autoDrop = False Then lockingLegende_Click(Me, EventArgs.Empty)
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.closeLegende.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
...
#End Region
    ...
    Private _AutoDrop As Boolean = False
...
#Region "Propriétés"
    ...
    Public Property lockedImage() As Bitmap
        ...
        Set(ByVal value As Bitmap)
            _lockedImage = value
            If isLocked Then LockingLegende.Image = value
        End Set
    End Property
    ...
    Public Property unlockedImage() As Bitmap
        ...
        Set(ByVal value As Bitmap)
            ...
            If isLocked = False Then LockingLegende.Image = value
        End Set
    End Property
...
#End Region
    ...
    Private Sub legendes_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
        ...
        If downArrowImage IsNot Nothing Then
            Dim flecheBmp As Bitmap = downArrowImage.Clone
    ...
    Private Sub legendeTimer_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LegendeTimer.Tick
        If isLocked = True Then Exit Sub
    ...
    Private Sub lockingLegende_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LockingLegende.Click
        If isLocked Then
            LockingLegende.Image = unlockedImage
            isLocked = True
        Else
            LockingLegende.Image = lockedImage
            isLocked = False
        End If
    End Sub
