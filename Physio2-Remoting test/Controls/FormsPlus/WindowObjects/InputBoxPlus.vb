...
#End Region
    ...
    Protected Overridable Sub onLoadCombo()
        REM shall be in child object
        ...
        '    If .PathOfList <> "" Then
        '        .Items.Clear()
        '        Dim LoadingData() As String = ReadFile(.PathOfList, , False)
        '        If LoadingData(0).StartsWith("ERROR") = False Then .Items.AddRange(LoadingData)
        '    End If
        'End With
    End Sub
    ...
    Private Sub ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ok.Click
        ...
        If MyPrompt.Text.IndexOf("\#") <> -1 And Increment.Checked = False Then
            ...
            ElseIf verifDialogResult = Windows.Forms.DialogResult.Cancel Then
                Exit Sub
            End If
        End If
        ...
        Else
            ...
            For i = From.Text To Upto.Text
                myAnswer &= _Separator & MyPrompt.Text.Replace("\#", addZeros(i, NombreChiffre.Text))
            Next i
