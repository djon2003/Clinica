...
#End Region
    ...
    Public Property selectImage() As Bitmap
        Get
            Return Me.selectDate.Image
        End Get
        Set(ByVal value As Bitmap)
            Me.selectDate.Image = value
        End Set
    End Property
    ...
    Private Sub disponibilites_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If DateDebut.Text = "" Then DateDebut.Text = DateFormat.affTextDate(Date.Today)
    ...
    Private Sub selectDate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles selectDate.Click
        ...
        myDateChoice.startYear = Date.Today.Year
        myDateChoice.endYear = Date.Today.Year + 1
        myDateChoice.selectedDate = CDate(DateDebut.Text)
        Dim newDate As Generic.List(Of Date) = myDateChoice.choose(False)
        If newDate.Count <> 0 Then
            DateDebut.Text = DateFormat.affTextDate(newDate(0))
        End If
    End Sub
End Class
