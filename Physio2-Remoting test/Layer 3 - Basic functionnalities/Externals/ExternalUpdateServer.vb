...
Public Class ExternalUpdateServer
    Implements IExternalUpdate, IDataConsumer(Of DataTCP)
...
#End Region
    ...
    Public Sub dataConsume(ByVal data As Base.DataTCP) Implements Base.IDataConsumer(Of Base.DataTCP).dataConsume
