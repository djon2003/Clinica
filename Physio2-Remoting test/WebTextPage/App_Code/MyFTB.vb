...
Public Class MyFTB
    ...
    Protected Overrides Sub renderRichEditor(ByVal writer As System.Web.UI.HtmlTextWriter)
        ...
        writer.WriteLine("div id=""" & Me.ClientID & "_designEditorArea"" style=""clear:both;padding-top:1px;"">" _
          & "<" & IIf(EditorTag = EditingTag.IFRAME, "IFRAME", "DIV").ToString & " id=""" & Me.ClientID & "_designEditor"" style=""padding: 0px; width:" & iframeWidth & "; height: " & iframeHeight & ";"" src=""about:blank"" class=""" & Me.ClientID & "_DesignBox""""></" & IIf(EditorTag = EditingTag.IFRAME, "IFRAME", "DIV").ToString & ">" _
      & "</div>" _
