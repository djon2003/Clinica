...
Public Class DBLinker
    ...
    Private lockingMutex As New System.Threading.Mutex()
...
#End Region
    ...
    Public Sub updateDB(ByVal tableName As String, ByVal setString As String, Optional ByVal whereFieldName As String = "", Optional ByVal whereFieldCondition As String = "", Optional ByVal quoted As Boolean = True, Optional ByVal whereOperator As String = "=", Optional ByVal showErrorMessage As Boolean = True, Optional ByVal didOnce As Boolean = False)
        ...
        If whereFieldName <> "" Then whereCmd = " WHERE (((" & tableName & "." & whereFieldName & ") " & whereOperator & " " & quotation & whereFieldCondition & quotation & "));" : whereCmd = whereCmd.Replace("= null", "IS null").Replace("<> null", "IS NOT Null")
    ...
    Public Shared Sub executeSQLScript(ByVal script As String)
        ...
        Dim sql() As String = System.Text.RegularExpressions.Regex.Split(script, "^GO.?$", System.Text.RegularExpressions.RegexOptions.Multiline Or System.Text.RegularExpressions.RegexOptions.IgnoreCase)
