...
Public MustInherit Class DBItemableManagerBase(Of Self, Managed)
    ...
    Implements IDBItemableManager(Of Self, Managed), DataConsumer(Of DataInternalUpdate)
    ...
    Public MustOverride Sub dataConsume(ByVal dataReceived As DataInternalUpdate) Implements DataConsumer(Of DataInternalUpdate).dataConsume
    Public MustOverride Sub load() Implements IDBItemableManager(Of Self, Managed).load

#Region "Properties"
    Public Overridable ReadOnly Property priority() As Integer Implements DataConsumer(Of DataInternalUpdate).priority
        Get
            Return 0
        End Get
    End Property
