...
#Region "Singleton"
    ...
    Protected Shared Sub createInstance()
        If mySelf Is Nothing Then
            Dim constructor As System.Reflection.ConstructorInfo = GetType(Self).GetConstructor(Reflection.BindingFlags.NonPublic Or Reflection.BindingFlags.Instance, Nothing, New System.Type() {}, Nothing)
