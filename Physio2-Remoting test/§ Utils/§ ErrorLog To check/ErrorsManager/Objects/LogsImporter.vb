Public Class LogsImporter
    ...
    Public Overloads Overrides Sub import(ByVal folder As String, ByVal recursive As Boolean)
        Dim files() As String = System.IO.Directory.GetFiles(folder, "*.log", IIf(recursive, IO.SearchOption.AllDirectories, IO.SearchOption.TopDirectoryOnly))
    ...
    Public Overloads Overrides Sub import(ByVal filename As String)
        Dim fileContent As String = IO.File.ReadAllText(filename, System.Text.Encoding.Default)
